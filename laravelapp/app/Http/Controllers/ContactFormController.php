...
class ContactFormController extends Controller
{
    ...
    {
        //dd($request, $request->name); //Requestの中身を見るため
        ...
        $user = ContactForm::create([
            ...
            'age' => $request->age,
            'contact' => $request->contact, //DBへの保存 モデル user.phpの$fillableにあるものがここで設定可能
        ]);
    ...
    {
        //
        $contact = ContactForm::find($id); //数字を入れてあげるとデータベースの情報を持ってくる
