                      ...
                      <div class="flex flex-wrap -m-2">
                          ...
                          <div class="relative">
                            <label class="leading-7 text-sm text-gray-600">性別</label><br>
                             ...
                             {{-- @if( $contact->gender  }}===1) --}}
                            <input type="radio"  name="gender" value="1" @if($contact->gender ===0 )checked @endif>男性
                            <input type="radio"  name="gender" value="2" @if($contact->gender ===1 )checked @endif>女性
                          </div>
                          </div>
                          ...
                          <div class="p-2 w-full">
                            <div class="relative">
                              ...
                              <select name="age">
                                  ...
                                  <option value="6" @if($contact->age ===6 )selected @endif>60歳～69歳</option>
                              </select>
                            </div>
                          </div>
